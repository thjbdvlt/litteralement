...
CREATE TABLE litteralement.token (
    phrase integer NOT NULL REFERENCES litteralement.phrase(id),
...
ALTER TABLE litteralement.mot add constraint mot_phrase_fk foreign key (phrase) references litteralement.phrase(id); -- TEST
...
ALTER TABLE ONLY litteralement.token
    ADD CONSTRAINT token_phrase_num_key UNIQUE (phrase, num);
