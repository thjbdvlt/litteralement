...
--
-- Name: _document; Type: TABLE; Schema: litteralement; Owner: -
--
...
--
-- Name: phrase_id_seq; Type: SEQUENCE; Schema: litteralement; Owner: -
--

ALTER TABLE litteralement.phrase ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME litteralement.phrase_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: phrase phrase_pkey; Type: CONSTRAINT; Schema: litteralement; Owner: -
--
...
--
-- Name: token token_phrase_num_key; Type: CONSTRAINT; Schema: litteralement; Owner: -
--

ALTER TABLE ONLY litteralement.token
    ADD CONSTRAINT token_phrase_num_key UNIQUE (phrase, n);
...
CREATE INDEX mot_num_idx ON litteralement.mot USING btree (n);
...
--
-- Name: mot mot_phrase_fk; Type: FK CONSTRAINT; Schema: litteralement; Owner: -
--

ALTER TABLE ONLY litteralement.mot
    ADD CONSTRAINT mot_phrase_fk FOREIGN KEY (phrase) REFERENCES litteralement.phrase(id);
...
--
-- Name: token token_phrase_fkey; Type: FK CONSTRAINT; Schema: litteralement; Owner: -
--

ALTER TABLE ONLY litteralement.token
    ADD CONSTRAINT token_phrase_fkey FOREIGN KEY (phrase) REFERENCES litteralement.phrase(id);
