...
create table nlp.segment (
    texte int references public.texte(id) not null,
    debut int not null,
    fin int not null
);
...
alter table public.prop_int add constraint prop_int_type_fk foreign key (type) references onto.type_propriete(id);
